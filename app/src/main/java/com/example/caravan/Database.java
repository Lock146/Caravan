...
public class Database {
    ...
    private ArrayList<SuggestedStop> m_suggestedStops;
    ...
    public void append_to_suggestions(GooglePlaceModel suggestion) {
        ArrayList<SuggestedStop> currentSuggestions = new ArrayList<>(m_suggestedStops);
        currentSuggestions.add(new SuggestedStop(suggestion));
    ...
    public ArrayList<SuggestedStop> get_suggested_stops(){
        ...
        m_groupListener = new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                if(value != null){
                    ...
                    m_suggestedStops = (ArrayList<SuggestedStop>) value.get(KEY_SUGG_STOPS);
                }
            }
        };
